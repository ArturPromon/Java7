...
public class Main22 {
    public static void main(String[] args) {
        ...
        while (isTrue2){
            isTrue = true;
            System.out.println("Game rules: First number is secret. Sum of two numbers must be lower than 50");
            ...
            while(isTrue){
                if(num2 < 25){
                    ...
                    System.out.println("Please write a second number one more time: ");
                    num2 = scn.nextInt();
                }else{
                    result = num1 + num2;
                    if(result>50){
